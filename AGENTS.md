...
- Синтаксис коммитов: на русском, понятным языком (пример: `Добавила заглушки страниц`). Conventional Commits (`feat:`, `chore:`) опционален, можно добавить позже.
...
*Обновлено: 03.09.2026. Структура страниц готова, первый пуш в GitHub выполнен. Следующий шаг на выбор: вёрстка или авторизация (в отдельной ветке `feature/auth`).*