...
export default function EyeCrossedIcon({ className }: Props) {
  return (
    <svg
      className={className}
      width="18"
    ...
    >
      ...
      />
      <path
        d="M11.3288 9.52417C11.1548 10.4917 10.3928 11.2552 9.42603 11.4307"
        stroke="#ADA4A5"
        strokeWidth="1.2"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      />
      <path
        d="M14.5858 6.74316C15.1018 7.42866 15.5556 8.21991 15.9373 9.10266C14.4621 12.5204 11.8551 14.5792 8.99983 14.5792C8.35258 14.5792 7.71433 14.4742 7.10083 14.2694"
        stroke="#ADA4A5"
        strokeWidth="1.2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M14.9152 3.18726L3.08472 15.0178"
        stroke="#ADA4A5"
        strokeWidth="1.2"
        strokeLinecap="round"
        strokeLinejoin="round"
